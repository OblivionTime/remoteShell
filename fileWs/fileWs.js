 ...
 * @LastEditors: solid
 * @LastEditTime: 2022-11-04 11:15:23
 */
const WebSocket = require('ws');
let deviceWSClientSet = require('../clients/file_clients.js');
...
module.exports = function () {
    ...
    wss.on('connection', (ws, req) => {
        ...
        //退出
        ws.on('close', () => {
            console.log("文件界面=>" + name + "离开");
            if (deviceWSClientSet.file_client_map.hasOwnProperty(room)) {
